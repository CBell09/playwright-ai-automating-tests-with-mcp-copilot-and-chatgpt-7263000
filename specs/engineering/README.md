...
- **test-automation-patterns.md** – Playwright test conventions: new/refactored tests must use page objects (not raw locator chains), one page object class per file under `tests/pages/`, following Playwright's POM doc.
